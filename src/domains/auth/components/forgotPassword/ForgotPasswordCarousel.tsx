...
function ForgotPasswordCarousel(props: Props) {
    return (
        <div className="flex-grow self-stretch h-full md:min-h-screen flex justify-center items-center bg-[#E6F4FF] p-4 relative">
